...
namespace Inspectors
{
    ...
    public class FindPropertyDrawer : PropertyDrawer
    {
            ...
            Dictionary<string, List<Object>> cache)
        {
            ...
            if (!cache.TryGetValue(fieldName, out var objects))
            {
                ...
                if (fieldTypeIsGameObject)
                {
                    ...
                    //     .Where(_ => _ != null)
                    //     .ToList();
                    objects = destGameObject.GetComponentsInChildren<Object>().ToList();
                }
                else
                {
                    // objects = destGameObject.Children()
                    ...
                    // .Where(_ => _ != null)
                    // .ToList();
                    objects = destGameObject.GetComponentsInChildren(fieldType).Cast<Object>().ToList();
                }
        ...
        {
            child = target.transform.Find(childName).gameObject; //;.Child(childName);
            return child != null;
        }
